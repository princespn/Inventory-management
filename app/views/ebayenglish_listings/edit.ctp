...
<?php echo $this->Form->create('EbayenglishListing');?>
	<fieldset>
		...
		<?php $description = mb_convert_encoding($this->data['EbayenglishListing']['description'], "UTF-8", mb_detect_encoding($this->data['EbayenglishListing']['description'], "UTF-8, ISO-8859-1, ISO-8859-15", true));
