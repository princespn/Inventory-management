...
<?php echo $this->Form->create('InventoryMaster',array('charset'=>'UTF-8')); ?>
	<fieldset>
		...
		echo $this->Form->input('browse_nodes');
		echo $this->Form->input('price');		
		echo $this->Form->input('title',array('id'=>'sessiontitle','maxlength'=>'500','error' => 'Title maximum length is 500 characters.'));
		?><div class="text_errror">Number of chars: <span id="sessiontitle_counter">500</span></div>
	
	<?php echo $this->Form->input('description',array('id'=>'sessiondesc','maxlength'=>'2000','error' => 'description maximum length is 2000 characters.'));
