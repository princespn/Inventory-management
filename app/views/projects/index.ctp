...
?>
 <?php
 //$option = $this->requestAction('/projects/category');
// debug($option) ;die();
...
<?php  echo $form->create('Project',array('action'=>'index','id'=>'saveForm')); ?>
	...
	<tr style="background:#666666;color:#ffffff;">				
			...
			<th><?php __('Product Code');?></th>
                       ...
                       <?php $option = $this->requestAction('/projects/categoriesPro'); //echo $this->Form->select('category',array($option)); 
...
document.getElementById("InventoryMasterCategory").onchange = function() {
     ...
     window.location.href = "http://212.227.103.36:8888/projects/category/" + selectedOption;
}
</script>
<?php } ?>
