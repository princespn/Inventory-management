...
<?php echo $this->Form->create('Project');?>
	...
	<?php echo $this->Form->input('bullet_point2',array('id'=>'sessionbullet2','maxlength'=>'500','error' => 'Bullet Point1 maximum length is 500 characters.'));
		?><div class="text_errror">Number of chars: <span id="sessionbullet2_counter">500</span></div>
	<?php echo $this->Form->input('bullet_point3',array('id'=>'sessionbullet3','maxlength'=>'500','error' => 'Bullet Point1 maximum length is 500 characters.'));
		?><div class="text_errror">Number of chars: <span id="sessionbullet3_counter">500</span></div>
	<?php echo $this->Form->input('bullet_point4',array('id'=>'sessionbullet4','maxlength'=>'500','error' => 'Bullet Point1 maximum length is 500 characters.'));
